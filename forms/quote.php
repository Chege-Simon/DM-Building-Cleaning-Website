<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      try {
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = $firstName. " " . $lastName. " is requesting for a quotation.";
        $body = file_get_contents('quotemailhtml.html');
        ...
        $mail->send();
        if($lang == 'en'){
          $resultMessage = "'Thank you for requesting a quote from us!'"; 
        }else{
          $resultMessage = "'Vielen Dank, dass Sie ein Angebot von uns angefordert haben!'"; 
        } 
    } catch (Exception $e) {
        if($lang == 'en'){
